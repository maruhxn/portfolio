...
export const PROJECTS: ProjectMeta[] = [
  {
    slug: "eventmaker",
    title: "이벤트메이커",
    summary: "참여 응답에서 외부 포인트 지급 호출을 비동기로 분리하고, 상태 머신·재시도 워커·대사 시스템으로 장애 상황에서도 지급이 유실 없이 정합성을 갖추게 한 서비스. 부하테스트로 목표치였던 100 TPS보다 약 22배 높은 2193 TPS까지 처리량을 끌어올렸습니다.",
